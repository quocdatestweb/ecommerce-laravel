...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('products.user') }}">Show Product</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('posts.user') }}">Show Post</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container bootstrap snippets bootdey pt-5">
                    ...
                    <section class="widget" >
                        <div class="widget-body" >
                            ...
                            <div class="post-user mt-sm">
                                ...
                                <p class="fs-mini text-muted"><time><i class="fa fa-calendar"></i> {{ $post->created_at }}</time> &nbsp; </p>
                            </div>
        ...
        <div class="d-flex justify-content-end align-items-center">
            {{ $posts->links('posts::custom-pagination') }}
